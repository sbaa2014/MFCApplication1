...
public:
	...
	TEnumAsByte<enum class MovieScene3DPathSection_Axis> FrontAxisEnum;                                    		// 0x00C8(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class MovieScene3DPathSection_Axis> UpAxisEnum;                                       		// 0x00C9(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class ECameraAnimPlaySpace>       PlaySpace;                                        		// 0x005A(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class ECameraAnimPlaySpace>       PlaySpace;                                        		// 0x004C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	TEnumAsByte<enum class ELevelVisibility>           Visibility;                                       		// 0x0040(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
