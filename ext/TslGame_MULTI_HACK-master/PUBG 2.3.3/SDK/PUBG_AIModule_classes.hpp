...
public:
	...
	TEnumAsByte<enum class EBTFlowAbortMode>           FlowAbortMode;                                    		// 0x0064(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class EPathFollowingRequestResult> MoveToLocation(const class Vector3D& Dest, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bProjectDestinationToNavigation, bool bCanStrafe, class UClass* FilterClass, bool bAllowPartialPath);
	TEnumAsByte<enum class EPathFollowingRequestResult> MoveToActor(class AActor* Goal, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bCanStrafe, class UClass* FilterClass, bool bAllowPartialPath);
	...
	TEnumAsByte<enum class EPathFollowingStatus> GetMoveStatus();
...
public:
	...
	TEnumAsByte<enum class EPathFollowingAction> GetPathActionType();
};
...
public:
	...
	void OnMoveCompleted(const struct FAIRequestID& RequestID, TEnumAsByte<enum class EPathFollowingResult> MovementResult);
};
...
public:
	...
	bool K2_PushAction(class UPawnAction* NewAction, TEnumAsByte<enum class EAIRequestPriority> Priority, class UObject* Instigator);
	bool STATIC_K2_PerformAction(class APawn* Pawn, class UPawnAction* Action, TEnumAsByte<enum class EAIRequestPriority> Priority);
	TEnumAsByte<enum class EPawnActionAbortState> K2_ForceAbortAction(class UPawnAction* ActionToAbort);
	TEnumAsByte<enum class EPawnActionAbortState> K2_AbortAction(class UPawnAction* ActionToAbort);
};
...
public:
	...
	TEnumAsByte<enum class ECollisionChannel>          DefaultSightCollisionChannel;                     		// 0x007A(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_GlobalConfig, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class EAISenseNotifyType>         NotifyType;                                       		// 0x002C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Config, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
...
public:
	...
	void OnPerceptionStimuliSourceEndPlay(class AActor* Actor, TEnumAsByte<enum class EEndPlayReason> EndPlayReason);
...
public:
	...
	void OnOwnerEndPlay(class AActor* Actor, TEnumAsByte<enum class EEndPlayReason> EndPlayReason);
...
public:
	...
	class UAITask_MoveTo* STATIC_AIMoveTo(class AAIController* Controller, const class Vector3D& GoalLocation, class AActor* GoalActor, float AcceptanceRadius, TEnumAsByte<enum class EAIOptionFlag> StopOnOverlap, TEnumAsByte<enum class EAIOptionFlag> AcceptPartialPath, bool bUsePathfinding, bool bLockAILogic);
};
...
public:
	...
	TEnumAsByte<enum class EBTBlackboardRestart>       NotifyObserver;                                   		// 0x00B9(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	void ReceiveExecutionFinishAI(class AAIController* OwnerController, class APawn* ControlledPawn, TEnumAsByte<enum class EBTNodeResult> NodeResult);
	void ReceiveExecutionFinish(class AActor* OwnerActor, TEnumAsByte<enum class EBTNodeResult> NodeResult);
...
public:
	...
	TEnumAsByte<enum class EGameplayContainerMatchType> TagsToMatch;                                      		// 0x0090(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	TEnumAsByte<enum class EBlackBoardEntryComparison> Operator;                                         		// 0x0068(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class EPathExistanceQueryType>    PathQueryType;                                    		// 0x00BC(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class EEnvQueryRunMode>           RunMode;                                          		// 0x00C0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_EditConst, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class EAIRequestPriority> GetActionPriority();
	void Finish(TEnumAsByte<enum class EPawnActionResult> WithResult);
...
public:
	...
	void EQSQueryDoneSignature__DelegateSignature(class UEnvQueryInstanceBlueprintWrapper* QueryInstance, TEnumAsByte<enum class EEnvQueryStatus> QueryStatus);
};
...
public:
	...
	class UEnvQueryInstanceBlueprintWrapper* STATIC_RunEQSQuery(class UObject* WorldContext, class UEnvQuery* QueryTemplate, class UObject* Querier, TEnumAsByte<enum class EEnvQueryRunMode> RunMode, class UClass* WrapperClass);
};
...
public:
	...
	TEnumAsByte<enum class EPointOnCircleSpacingMethod> PointOnCircleSpacingMethod;                       		// 0x0110(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class EEnvTestPurpose>            TestPurpose;                                      		// 0x0034(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                               		// 0x0035(0x0003) MISSED OFFSET
	struct FString                                     TestComment;                                      		// 0x0038(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance)
	TEnumAsByte<enum class EEnvTestFilterOperator>     MultipleContextFilterOp;                          		// 0x0048(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	TEnumAsByte<enum class EEnvTestScoreOperator>      MultipleContextScoreOp;                           		// 0x0049(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	TEnumAsByte<enum class EEnvTestFilterType>         FilterType;                                       		// 0x004A(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	TEnumAsByte<enum class EEnvTestScoreEquation>      ScoringEquation;                                  		// 0x00E1(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	TEnumAsByte<enum class EEnvQueryTestClamping>      ClampMinType;                                     		// 0x00E2(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	TEnumAsByte<enum class EEnvQueryTestClamping>      ClampMaxType;                                     		// 0x00E3(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
...
{
public:
	TEnumAsByte<enum class EEnvTestDistance>           TestMode;                                         		// 0x01C0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class EEnvTestDot>                TestMode;                                         		// 0x0200(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
...
{
public:
	TEnumAsByte<enum class EGameplayContainerMatchType> TagsToMatch;                                      		// 0x01C0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                               		// 0x01C1(0x0007) MISSED OFFSET
...
{
public:
	TEnumAsByte<enum class EEnvTestPathfinding>        TestMode;                                         		// 0x01C0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                               		// 0x01C1(0x0007) MISSED OFFSET
...
public:
	...
	TEnumAsByte<enum class EEnvQueryHightlightMode>    HighlightMode;                                    		// 0x07E8(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	TEnumAsByte<enum class EEnvQueryRunMode>           QueryingMode;                                     		// 0x07F0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	void ActionFinished(class APawn* ControlledPawn, TEnumAsByte<enum class EPawnActionResult> WithResult);
};
...
public:
	...
	TEnumAsByte<enum class EPawnActionFailHandling>    ChildFailureHandlingMode;                         		// 0x00E0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
