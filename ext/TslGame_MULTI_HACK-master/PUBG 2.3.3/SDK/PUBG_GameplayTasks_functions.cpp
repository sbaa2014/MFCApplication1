...
class UGameplayTask_SpawnActor* UGameplayTask_SpawnActor::STATIC_SpawnActor(const TScriptInterface<class UGameplayTaskOwnerInterface>& TaskOwner, const class Vector3D& SpawnLocation, const class Rotator& SpawnRotation, class UClass* Class, bool bSpawnOnlyOnAuthority)
{
	...
	struct
	{
		...
		class Vector3D                 SpawnLocation;
		class Rotator                  SpawnRotation;
		class UClass*                  Class;
...
TEnumAsByte<enum class EGameplayTaskRunResult> UGameplayTasksComponent::STATIC_K2_RunGameplayTask(const TScriptInterface<class UGameplayTaskOwnerInterface>& TaskOwner, class UGameplayTask* Task, unsigned char Priority, TArray<class UClass*> AdditionalRequiredResources, TArray<class UClass*> AdditionalClaimedResources)
{
	...
	struct
	{
		...
		TEnumAsByte<enum class EGameplayTaskRunResult> ReturnValue;
	} params;
	params.TaskOwner = TaskOwner;
	params.Task = Task;
	params.Priority = Priority;
