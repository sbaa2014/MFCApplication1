...
public:
	...
	TEnumAsByte<enum class ESlateVisibility> Get_Killer_Visibility_1();
	TEnumAsByte<enum class ESlateVisibility> Get_Insert2_Visibility_1();
	TEnumAsByte<enum class ESlateVisibility> Get_Insert_Visibility_1();
