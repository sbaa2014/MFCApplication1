...
struct FNiagaraVariableInfo
{
	...
	TEnumAsByte<enum class ENiagaraDataType>           Type;                                             		// 0x0008(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
{
	struct FName                                       Name;                                             		// 0x0000(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class ENiagaraDataSetType>        Type;                                             		// 0x0008(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
};
