...
public:
	...
	void BndEvt__ComboBox_K2Node_ComponentBoundEvent_0_OnSelectionChangedEvent__DelegateSignature(const struct FString& SelectedItem, TEnumAsByte<enum class ESelectInfo> SelectionType);
	void ExecuteUbergraph_QualityComboBox(int EntryPoint);
	void OnSelectionChanged__DelegateSignature(const struct FString& SelectedItem, TEnumAsByte<enum class ESelectInfo> SelectionType);
};
