...
public:
	...
	TEnumAsByte<enum class ETimelineDirection>         _____0__Direction_48D534754930C313D14949AAF35C3B50;		// 0x0574(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                               		// 0x0575(0x0003) MISSED OFFSET
	class UTimelineComponent*                          АР„З|·xЗ_1;                                       		// 0x0578(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
