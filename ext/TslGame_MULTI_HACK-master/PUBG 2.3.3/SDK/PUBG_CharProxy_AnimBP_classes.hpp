...
public:
	...
	TEnumAsByte<enum class EAnimWeaponType>            AnimWeaponType;                                   		// 0x1EA0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	TEnumAsByte<enum class EWeaponClass>               WeaponClassEnum;                                  		// 0x1ED4(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	void GetAnimWeaponType(TEnumAsByte<enum class EAnimWeaponType>* AnimWeaponType);
