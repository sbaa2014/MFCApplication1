...
{
	TEnumAsByte<enum class EBTDecoratorLogic>          Operation;                                        		// 0x0000(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FAIDynamicParam
{
	...
	TEnumAsByte<enum class EAIParamType>               ParamType;                                        		// 0x0008(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_EditConst, CPF_IsPlainOldData)
...
struct FEQSParametrizedQueryExecutionRequest
{
	...
	TEnumAsByte<enum class EEnvQueryRunMode>           RunMode;                                          		// 0x0040(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FEnvNamedValue
{
	...
	TEnumAsByte<enum class EAIParamType>               ParamType;                                        		// 0x0008(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                               		// 0x0009(0x0003) MISSED OFFSET
	float                                              Value;                                            		// 0x000C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FEnvTraceData
{
	...
	TEnumAsByte<enum class ETraceTypeQuery>            TraceChannel;                                     		// 0x0028(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	TEnumAsByte<enum class ECollisionChannel>          SerializedChannel;                                		// 0x0029(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	TEnumAsByte<enum class EEnvTraceShape>             TraceShape;                                       		// 0x002A(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	TEnumAsByte<enum class EEnvQueryTrace>             TraceMode;                                        		// 0x002B(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
...
struct FEnvDirection
{
	...
	TEnumAsByte<enum class EEnvDirection>              DirMode;                                          		// 0x0018(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
};
...
struct FEnvOverlapData
{
	...
	TEnumAsByte<enum class ECollisionChannel>          OverlapChannel;                                   		// 0x0018(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	TEnumAsByte<enum class EEnvOverlapShape>           OverlapShape;                                     		// 0x0019(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
