...
{
public:
	int                                                ComponentSizeQuads;                               		// 0x06A0(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                SubsectionSizeQuads;                              		// 0x06A4(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                NumSubsections;                                   		// 0x06A8(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                               		// 0x06AC(0x0004) MISSED OFFSET
	class UMaterialInterface*                          OverrideMaterial;                                 		// 0x06B0(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UMaterialInterface*                          OverrideHoleMaterial;                             		// 0x06B8(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TArray<class UMaterialInstanceConstant*>           MaterialInstances;                                		// 0x06C0(0x0010) (CPF_ZeroConstructor)
	TArray<struct FWeightmapLayerAllocationInfo>       WeightmapLayerAllocations;                        		// 0x06D0(0x0010) (CPF_ZeroConstructor)
	TArray<class UTexture2D*>                          WeightmapTextures;                                		// 0x06E0(0x0010) (CPF_ZeroConstructor)
	class UTexture2D*                                  XYOffsetmapTexture;                               		// 0x06F0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                               		// 0x06F8(0x0008) MISSED OFFSET
	struct FVector4                                    WeightmapScaleBias;                               		// 0x0700(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              WeightmapSubsectionOffset;                        		// 0x0710(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0xC];                               		// 0x0714(0x000C) MISSED OFFSET
	struct FVector4                                    HeightmapScaleBias;                               		// 0x0720(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UTexture2D*                                  HeightmapTexture;                                 		// 0x0730(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FBox                                        CachedLocalBox;                                   		// 0x0738(0x001C) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	TLazyObjectPtr<class ULandscapeHeightfieldCollisionComponent> CollisionComponent;                               		// 0x0754(0x001C) (CPF_ExportObject, CPF_InstancedReference, CPF_IsPlainOldData)
	struct FGuid                                       MapBuildDataId;                                   		// 0x0770(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	TArray<struct FGuid>                               IrrelevantLights;                                 		// 0x0780(0x0010) (CPF_ZeroConstructor, CPF_Deprecated)
	int                                                CollisionMipLevel;                                		// 0x0790(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                SimpleCollisionMipLevel;                          		// 0x0794(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              NegativeZBoundsExtension;                         		// 0x0798(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              PositiveZBoundsExtension;                         		// 0x079C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              StaticLightingResolution;                         		// 0x07A0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                ForcedLOD;                                        		// 0x07A4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                LODBias;                                          		// 0x07A8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FGuid                                       StateId;                                          		// 0x07AC(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FGuid                                       BakedTextureMaterialGuid;                         		// 0x07BC(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                               		// 0x07CC(0x0004) MISSED OFFSET
	class UTexture2D*                                  GIBakedBaseColorTexture;                          		// 0x07D0(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_EditConst, CPF_IsPlainOldData)
	unsigned char                                      MobileBlendableLayerMask;                         		// 0x07D8(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData04[0x7];                               		// 0x07D9(0x0007) MISSED OFFSET
	class UMaterialInterface*                          MobileMaterialInterface;                          		// 0x07E0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UTexture2D*                                  MobileWeightNormalmapTexture;                     		// 0x07E8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	int                                                SectionBaseX;                                     		// 0x06A8(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                SectionBaseY;                                     		// 0x06AC(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                CollisionSizeQuads;                               		// 0x06B0(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              CollisionScale;                                   		// 0x06B4(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                SimpleCollisionSizeQuads;                         		// 0x06B8(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                               		// 0x06BC(0x0004) MISSED OFFSET
	TArray<unsigned char>                              CollisionQuadFlags;                               		// 0x06C0(0x0010) (CPF_ZeroConstructor)
	struct FGuid                                       HeightfieldGuid;                                  		// 0x06D0(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FBox                                        CachedLocalBox;                                   		// 0x06E0(0x001C) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	TLazyObjectPtr<class ULandscapeComponent>          RenderComponent;                                  		// 0x06FC(0x001C) (CPF_ExportObject, CPF_InstancedReference, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x10];                              		// 0x0718(0x0010) MISSED OFFSET
	TArray<class UPhysicalMaterial*>                   CookedPhysicalMaterials;                          		// 0x0728(0x0010) (CPF_ZeroConstructor)
...
public:
	...
	TArray<struct FIntPoint>                           ProxyComponentBases;                              		// 0x07E8(0x0010) (CPF_ZeroConstructor)
	int8_t                                             ProxyLOD;                                         		// 0x07F8(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	struct FGuid                                       LandscapeGuid;                                    		// 0x0390(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FIntPoint                                   LandscapeSectionOffset;                           		// 0x03A0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	TEnumAsByte<enum class ELandscapeLODFalloff>       LODFalloff;                                       		// 0x03B0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      bUseMaterialPositionOffsetInStaticLighting : 1;   		// 0x0478(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData04[0x3];                               		// 0x0479(0x0003) MISSED OFFSET
	struct FLightmassPrimitiveSettings                 LightmassSettings;                                		// 0x047C(0x0018) (CPF_Edit)
	int                                                CollisionMipLevel;                                		// 0x0494(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                SimpleCollisionMipLevel;                          		// 0x0498(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              CollisionThickness;                               		// 0x049C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FBodyInstance                               BodyInstance;                                     		// 0x04A0(0x01B0) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly)
	unsigned char                                      bGenerateOverlapEvents : 1;                       		// 0x0650(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly)
	unsigned char                                      bBakeMaterialPositionOffsetIntoCollision : 1;     		// 0x0650(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData05[0x3];                               		// 0x0651(0x0003) MISSED OFFSET
	int                                                ComponentSizeQuads;                               		// 0x0654(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                SubsectionSizeQuads;                              		// 0x0658(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                NumSubsections;                                   		// 0x065C(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bUsedForNavigation : 1;                           		// 0x0660(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData06[0x3];                               		// 0x0661(0x0003) MISSED OFFSET
	TEnumAsByte<enum class ENavDataGatheringMode>      NavigationGeometryGatheringMode;                  		// 0x0664(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bUseLandscapeForCullingInvisibleHLODVertices : 1; 		// 0x0665(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData07[0xDA];                              		// 0x0666(0x00DA) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x8];                               		// 0x06A0(0x0008) MISSED OFFSET
	TArray<class ULandscapeSplineSegment*>             Segments;                                         		// 0x06A8(0x0010) (CPF_ZeroConstructor)
	TArray<class UMeshComponent*>                      CookedForeignMeshComponents;                      		// 0x06B8(0x0010) (CPF_ExportObject, CPF_ZeroConstructor)
...
{
public:
	TEnumAsByte<enum class ETerrainCoordMappingType>   MappingType;                                      		// 0x0060(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class ELandscapeCustomizedCoordType> CustomUVType;                                     		// 0x0061(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
