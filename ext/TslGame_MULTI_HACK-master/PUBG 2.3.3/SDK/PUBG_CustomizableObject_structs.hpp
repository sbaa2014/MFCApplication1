...
struct FMutableModelImageProperties
{
	...
	TEnumAsByte<enum class TextureCompressionSettings> CompressionSettings;                              		// 0x0010(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class TextureFilter>              Filter;                                           		// 0x0011(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                               		// 0x0012(0x0002) MISSED OFFSET
	unsigned char                                      SRGB : 1;                                         		// 0x0014(0x0001)
	unsigned char                                      UnknownData01[0x3];                               		// 0x0015(0x0003) MISSED OFFSET
	int                                                LODBias;                                          		// 0x0018(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class TextureMipGenSettings>      MipGenSettings;                                   		// 0x001C(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FString                                     Name;                                             		// 0x0000(0x0010) (CPF_ZeroConstructor)
	TEnumAsByte<enum class EMutableParameterType>      Type;                                             		// 0x0010(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
