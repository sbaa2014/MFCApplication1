...
namespace Wininit
{
    ...
    {
        [FieldOffset(0xA0)] //AActor_Base
        public TArray<QQctor> AActors;
    }
    [StructLayout(LayoutKind.Explicit)]
    public struct QQctor
    {
        [FieldOffset(0x0)]
        ...
        public bool IsPlayer
        {
            get
            {
                ...
                //return this.Id == 63715 || this.Id == 63720;
            }
        }
        public FString getname()
        {
            return M.Read<FString>(PlayerName);
        }
        ...
        public bool IsVehicle
        {
            get
            {
                //if (G.Names[this.Id].ToString().Contains("Buggy"))
                //{
                //    return true;
                //}
                //if (G.Names[this.Id].ToString().Contains("Jeep"))
                //{
                //    return true;
                //}
                switch (this.Id)
    ...
    public struct UGameInstance
    {
        ...
        public ULocalPlayer LocalPlayer
        {
            get
            {
                ...
                //Console.WriteLine($"LocalPlayer base : {pLocalPlayer.ToString("x2")}");

                result.pBase = pLocalPlayer;
                //Console.WriteLine($"LocalPlayer.pBase base : {result.pBase.ToString("x2")}");
                return result;
            }
        }
    }
    ...
    public struct Vector3
    {
        ...
        public static Vector3 operator /(Vector3 vecA, Vector3 vecB) => new Vector3(vecA.X / vecB.X, vecA.Y / vecB.Y, vecA.Z / vecB.Z);
        public static Vector3 operator /(Vector3 vecA, int n) => new Vector3(vecA.X / n, vecA.Y / n, vecA.Z / n);
        public static Vector3 operator /(Vector3 vecA, float n) => new Vector3(vecA.X / n, vecA.Y / n, vecA.Z / n);
    ...
    public struct USceneComponent
    {
        ...
        [FieldOffset(0x1A0)]
        public Vector3 RelativeLocation;  //absolute Location
