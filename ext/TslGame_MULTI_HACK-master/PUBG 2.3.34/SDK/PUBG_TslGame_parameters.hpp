...
struct ADroppedItem_OnInteractBy_Params
{
	class ATslCharacter*                               OtherCharacter;                                           // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct ATslWeapon_UpdateAttachedItemClient_Params
{
...
struct ATslWeapon_OnRep_AttachedItemData_Params
{
};

// Function TslGame.TslWeapon.OnRep_AttachedItemAssets
struct ATslWeapon_OnRep_AttachedItemAssets_Params
{
};
...
struct ATslWeapon_Gun_UpdateAttachedItemClient_Params
{
	struct FWeaponAttachmentData                       NewAttachmentData;                                        // (CPF_ConstParm, CPF_Parm, CPF_ReferenceParm)
	struct FWeaponAttachmentData                       PastAttachmentData;                                       // (CPF_ConstParm, CPF_Parm, CPF_ReferenceParm)
};
...
struct ATslWeapon_Gun_OnRep_AttachedItemAssets_Params
{
};
...
struct ATslWeapon_Throwable_Client_NotifyDrop_Params
{
};
