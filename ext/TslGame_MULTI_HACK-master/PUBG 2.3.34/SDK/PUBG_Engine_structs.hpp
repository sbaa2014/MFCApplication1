...
struct FBodyInstance
{
	...
	unsigned char                                      UnknownData02[0x14];                                      // 0x00AC(0x0014) MISSED OFFSET
	...
	unsigned char                                      UnknownData03[0x28];                                      // 0x00E0(0x0028) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x90];                                      // 0x011C(0x0090) MISSED OFFSET
