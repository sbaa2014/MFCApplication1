...
void UWebPopup_C::SetPopupData(const struct FString& PopupId, const struct FString& Uri)
{
...
// Function WebPopup.WebPopup_C.LoadWebPage
// (FUNC_Public, FUNC_BlueprintCallable, FUNC_BlueprintEvent)

void UWebPopup_C::LoadWebPage()
{
	static auto fn = UObject::FindObject<UFunction>("Function WebPopup.WebPopup_C.LoadWebPage");

	UWebPopup_C_LoadWebPage_Params params;
