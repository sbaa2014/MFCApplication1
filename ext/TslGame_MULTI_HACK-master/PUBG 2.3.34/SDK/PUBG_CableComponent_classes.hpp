...
public:
	...
	class Vector3D                                     EndLocation;                                              // 0x0778(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	class Vector3D                                     CableForce;                                               // 0x079C(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData00[0x18];                                      // 0x07B8(0x0018) MISSED OFFSET
