...
{
public:
	TEnumAsByte<EWidgetSpace>                          Space;                                                    // 0x0750(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	TEnumAsByte<EWidgetBlendMode>                      BlendMode;                                                // 0x07BC(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0x3C];                                      // 0x0844(0x003C) MISSED OFFSET
