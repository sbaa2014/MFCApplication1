...
public:
	...
	TEnumAsByte<ETrackingStatus>                       CurrentTrackingStatus;                                    // 0x06A4(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x1B];                                      // 0x06A5(0x001B) MISSED OFFSET
