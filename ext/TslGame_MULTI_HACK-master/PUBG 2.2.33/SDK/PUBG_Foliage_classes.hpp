...
public:
	...
	struct FScriptMulticastDelegate                    OnInstanceTakeRadialDamage;                       		// 0x09B8(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
...
public:
	...
	TEnumAsByte<enum class EFoliageScaling>            Scaling;                                          		// 0x0044(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	TEnumAsByte<enum class FoliageVertexColorMask>     VertexColorMask;                                  		// 0x0090(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	...
	TEnumAsByte<enum class EComponentMobility>         Mobility;                                         		// 0x011C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	TEnumAsByte<enum class EHasCustomNavigableGeometry> CustomNavigableGeometry;                          		// 0x02F0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	struct FVector                                     TouchingActorEntryPosition;                       		// 0x03A0(0x000C) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	struct FVector                                     FoliageVelocity;                                  		// 0x03AC(0x000C) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	struct FVector                                     FoliageForce;                                     		// 0x03B8(0x000C) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	struct FVector                                     FoliagePosition;                                  		// 0x03C4(0x000C) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
