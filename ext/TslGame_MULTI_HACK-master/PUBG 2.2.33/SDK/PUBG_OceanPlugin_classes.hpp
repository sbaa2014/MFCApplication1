...
public:
	...
	TEnumAsByte<enum class ETickingGroup>              TickGroup;                                        		// 0x0388(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	struct FVector2D                                   GlobalWaveDirection;                              		// 0x038C(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData03[0x28];                              		// 0x03E8(0x0028) MISSED OFFSET
...
public:
	...
	struct FVector                                     VelocityDamper;                                   		// 0x0150(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FRotator                                    StayUprightDesiredRotation;                       		// 0x0194(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	struct FVector                                     VelocityDamper;                                   		// 0x09B0(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData03[0x8];                               		// 0x09D8(0x0008) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData04[0x28];                              		// 0x0810(0x0028) MISSED OFFSET
...
public:
	...
	struct FVector                                     underwaterMin;                                    		// 0x0470(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FVector                                     underwaterMax;                                    		// 0x047C(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData03[0xBF];                              		// 0x04A9(0x00BF) MISSED OFFSET
...
public:
	...
	TEnumAsByte<enum class EFollowMethod>              FollowMethod;                                     		// 0x0301(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
