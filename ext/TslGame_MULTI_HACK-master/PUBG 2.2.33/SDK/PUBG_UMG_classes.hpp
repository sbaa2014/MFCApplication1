...
public:
	...
	TEnumAsByte<enum class ESlateVisibility>           Visiblity;                                        		// 0x00A0(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	TEnumAsByte<enum class ESlateVisibility>           Visibility;                                       		// 0x00A1(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	TEnumAsByte<enum class EMouseCursor>               Cursor;                                           		// 0x00BC(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	void SetVisibility(TEnumAsByte<enum class ESlateVisibility> InVisibility);
	...
	void SetCursor(TEnumAsByte<enum class EMouseCursor> InCursor);
	void ResetCursor();
	...
	TEnumAsByte<enum class ESlateVisibility> GetVisibility();
	struct FText GetText__DelegateSignature();
	TEnumAsByte<enum class ESlateVisibility> GetSlateVisibility__DelegateSignature();
	struct FSlateColor GetSlateColor__DelegateSignature();
	struct FSlateBrush GetSlateBrush__DelegateSignature();
	class UPanelWidget* GetParent();
	class APlayerController* GetOwningPlayer();
	TEnumAsByte<enum class EMouseCursor> GetMouseCursor__DelegateSignature();
	struct FLinearColor GetLinearColor__DelegateSignature();
	bool GetIsEnabled();
	int GetInt32__DelegateSignature();
	float GetFloat__DelegateSignature();
	struct FVector2D GetDesiredSize();
	TEnumAsByte<enum class ECheckBoxState> GetCheckBoxState__DelegateSignature();
...
public:
	...
	void StopListeningForInputAction(const struct FName& ActionName, TEnumAsByte<enum class EInputEvent> EventType);
	...
	void PlayAnimationTo(class UWidgetAnimation* InAnimation, float StartAtTime, float EndAtTime, int NumLoopsToPlay, TEnumAsByte<enum class EUMGSequencePlayMode> PlayMode, float PlaybackSpeed);
	void PlayAnimation(class UWidgetAnimation* InAnimation, float StartAtTime, int NumLoopsToPlay, TEnumAsByte<enum class EUMGSequencePlayMode> PlayMode, float PlaybackSpeed);
	...
	void ListenForInputAction(const struct FName& ActionName, TEnumAsByte<enum class EInputEvent> EventType, bool bConsume, const struct FScriptDelegate& Callback);
...
public:
	...
	TEnumAsByte<enum class EDragPivot>                 Pivot;                                            		// 0x0048(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class ECheckBoxState> GetValue();
};
...
public:
	...
	TEnumAsByte<enum class EMouseCursor> GetValue();
};
...
public:
	...
	TEnumAsByte<enum class ESlateVisibility> GetValue();
};
...
public:
	...
	TEnumAsByte<enum class EHorizontalAlignment>       HorizontalAlignment;                              		// 0x0048(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class EVerticalAlignment>         VerticalAlignment;                                		// 0x0049(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	void SetVerticalAlignment(TEnumAsByte<enum class EVerticalAlignment> InVerticalAlignment);
	void SetPadding(const struct FMargin& InPadding);
	void SetHorizontalAlignment(TEnumAsByte<enum class EHorizontalAlignment> InHorizontalAlignment);
};
...
public:
	...
	TEnumAsByte<enum class EHorizontalAlignment>       HorizontalAlignment;                              		// 0x0048(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class EVerticalAlignment>         VerticalAlignment;                                		// 0x0049(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x16];                              		// 0x004A(0x0016) MISSED OFFSET
...
public:
	...
	TEnumAsByte<enum class EHorizontalAlignment>       HorizontalAlignment;                              		// 0x0050(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class EVerticalAlignment>         VerticalAlignment;                                		// 0x0051(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class EHorizontalAlignment>       HAlign;                                           		// 0x004C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class EVerticalAlignment>         VAlign;                                           		// 0x004D(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	TEnumAsByte<enum class EHorizontalAlignment>       HorizontalAlignment;                              		// 0x0038(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class EVerticalAlignment>         VerticalAlignment;                                		// 0x0039(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	void RefreshOptions();
	void OnSelectionChangedEvent__DelegateSignature(const struct FString& SelectedItem, TEnumAsByte<enum class ESelectInfo> SelectionType);
...
public:
	...
	TEnumAsByte<enum class ETextJustify>               Justification;                                    		// 0x0130(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	TEnumAsByte<enum class ETextWrappingPolicy>        WrappingPolicy;                                   		// 0x0138(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class EVirtualKeyboardType>       KeyboardType;                                     		// 0x047E(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	void OnEditableTextCommittedEvent__DelegateSignature(const struct FText& Text, TEnumAsByte<enum class ETextCommit> CommitMethod);
...
public:
	...
	TEnumAsByte<enum class EVirtualKeyboardType>       KeyboardType;                                     		// 0x0AA6(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	void OnEditableTextBoxCommittedEvent__DelegateSignature(const struct FText& Text, TEnumAsByte<enum class ETextCommit> CommitMethod);
...
public:
	...
	TEnumAsByte<enum class EHorizontalAlignment>       HorizontalAlignment;                              		// 0x0170(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class EVerticalAlignment>         VerticalAlignment;                                		// 0x0171(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class EButtonClickMethod>         ClickMethod;                                      		// 0x0410(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class EButtonTouchMethod>         TouchMethod;                                      		// 0x0411(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	TEnumAsByte<enum class ECheckBoxState>             CheckedState;                                     		// 0x0140(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	TEnumAsByte<enum class EHorizontalAlignment>       HorizontalAlignment;                              		// 0x0788(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	void SetCheckedState(TEnumAsByte<enum class ECheckBoxState> InCheckedState);
	bool IsPressed();
	bool IsChecked();
	TEnumAsByte<enum class ECheckBoxState> GetCheckedState();
};
...
public:
	...
	TEnumAsByte<enum class EMenuPlacement>             Placement;                                        		// 0x0158(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	TEnumAsByte<enum class EStretch>                   Stretch;                                          		// 0x0140(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class EStretchDirection>          StretchDirection;                                 		// 0x0141(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	void SetStretchDirection(TEnumAsByte<enum class EStretchDirection> InStretchDirection);
	void SetStretch(TEnumAsByte<enum class EStretch> InStretch);
...
public:
	...
	TEnumAsByte<enum class EOrientation>               Orientation;                                      		// 0x08B0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class ESlateVisibility>           ScrollBarVisibility;                              		// 0x08B1(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class EConsumeMouseWheel>         ConsumeMouseWheel;                                		// 0x08B2(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class EProgressBarFillType>       BarFillType;                                      		// 0x0304(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class EOrientation>               Orientation;                                      		// 0x0649(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class EOrientation>               Orientation;                                      		// 0x0390(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	void SetForegroundColor(const struct FSlateColor& InForegroundColor);
	void OnSpinBoxValueCommittedEvent__DelegateSignature(float InValue, TEnumAsByte<enum class ETextCommit> CommitMethod);
...
public:
	...
	TEnumAsByte<enum class ESelectionMode>             SelectionMode;                                    		// 0x0140(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	void SetText(const struct FText& InText);
	void OnMultiLineEditableTextCommittedEvent__DelegateSignature(const struct FText& Text, TEnumAsByte<enum class ETextCommit> CommitMethod);
...
public:
	...
	void SetText(const struct FText& InText);
	void SetError(const struct FText& InError);
	void OnMultiLineEditableTextBoxCommittedEvent__DelegateSignature(const struct FText& Text, TEnumAsByte<enum class ETextCommit> CommitMethod);
...
public:
	...
	void SetOpacity(float InOpacity);
	void SetJustification(TEnumAsByte<enum class ETextJustify> InJustification);
...
public:
	...
	void STATIC_SetInputMode_UIOnlyEx(class APlayerController* Target, class UWidget* InWidgetToFocus, TEnumAsByte<enum class EMouseLockMode> InMouseLockMode);
	...
	void STATIC_SetInputMode_GameAndUIEx(class APlayerController* Target, class UWidget* InWidgetToFocus, TEnumAsByte<enum class EMouseLockMode> InMouseLockMode, bool bHideCursorDuringCapture);
...
{
public:
	TEnumAsByte<enum class EWidgetSpace>               Space;                                            		// 0x0750(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                               		// 0x0751(0x0007) MISSED OFFSET
	class UClass*                                      WidgetClass;                                      		// 0x0758(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FIntPoint                                   DrawSize;                                         		// 0x0760(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bManuallyRedraw : 1;                              		// 0x0768(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bRedrawRequested : 1;                             		// 0x0769(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                               		// 0x076A(0x0002) MISSED OFFSET
	float                                              RedrawTime;                                       		// 0x076C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              LastWidgetRenderTime;                             		// 0x0770(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bWindowFocusable : 1;                             		// 0x0774(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                               		// 0x0775(0x0003) MISSED OFFSET
	struct FIntPoint                                   CurrentDrawSize;                                  		// 0x0778(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bDrawAtDesiredSize : 1;                           		// 0x0780(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                               		// 0x0781(0x0003) MISSED OFFSET
	struct FVector2D                                   Pivot;                                            		// 0x0784(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                               		// 0x078C(0x0004) MISSED OFFSET
	class ULocalPlayer*                                OwnerPlayer;                                      		// 0x0790(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                  		// 0x0798(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FLinearColor                                TintColorAndOpacity;                              		// 0x07A8(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              OpacityFromTexture;                               		// 0x07B8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class EWidgetBlendMode>           BlendMode;                                        		// 0x07BC(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bIsTwoSided : 1;                                  		// 0x07BD(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      TickWhenOffscreen : 1;                            		// 0x07BE(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData05[0x1];                               		// 0x07BF(0x0001) MISSED OFFSET
	class UUserWidget*                                 Widget;                                           		// 0x07C0(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient, CPF_IsPlainOldData)
	unsigned char                                      UnknownData06[0x20];                              		// 0x07C8(0x0020) MISSED OFFSET
	class UBodySetup*                                  BodySetup;                                        		// 0x07E8(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient, CPF_IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial;                              		// 0x07F0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial_OneSided;                     		// 0x07F8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial;                                   		// 0x0800(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial_OneSided;                          		// 0x0808(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial;                                   		// 0x0810(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial_OneSided;                          		// 0x0818(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UTextureRenderTarget2D*                      RenderTarget;                                     		// 0x0820(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient, CPF_IsPlainOldData)
	class UMaterialInstanceDynamic*                    MaterialInstance;                                 		// 0x0828(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient, CPF_IsPlainOldData)
	unsigned char                                      bAddedToScreen : 1;                               		// 0x0830(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient, CPF_IsPlainOldData)
	unsigned char                                      bEditTimeUsable : 1;                              		// 0x0831(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData07[0x6];                               		// 0x0832(0x0006) MISSED OFFSET
	struct FName                                       SharedLayerName;                                  		// 0x0838(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	int                                                LayerZOrder;                                      		// 0x0840(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class ECollisionChannel>          TraceChannel;                                     		// 0x0328(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	TEnumAsByte<enum class EWidgetInteractionSource>   InteractionSource;                                		// 0x0330(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
