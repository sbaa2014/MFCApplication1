...
{
	TEnumAsByte<enum class ESpriteShapeType>           ShapeType;                                        		// 0x0000(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_EditConst, CPF_IsPlainOldData)
...
struct FSpriteGeometryCollection
{
	...
	TEnumAsByte<enum class ESpritePolygonMode>         GeometryType;                                     		// 0x0010(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
