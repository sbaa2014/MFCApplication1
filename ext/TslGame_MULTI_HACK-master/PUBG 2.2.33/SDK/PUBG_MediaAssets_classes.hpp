...
public:
	...
	bool SelectTrack(TEnumAsByte<enum class EMediaPlayerTrack> TrackType, int TrackIndex);
	...
	struct FString GetTrackLanguage(TEnumAsByte<enum class EMediaPlayerTrack> TrackType, int TrackIndex);
	struct FText GetTrackDisplayName(TEnumAsByte<enum class EMediaPlayerTrack> TrackType, int TrackIndex);
	...
	int GetSelectedTrack(TEnumAsByte<enum class EMediaPlayerTrack> TrackType);
	struct FFloatRange GetReverseRates(bool Unthinned);
	float GetRate();
	struct FName GetPlayerName();
	int GetNumTracks(TEnumAsByte<enum class EMediaPlayerTrack> TrackType);
...
public:
	...
	TEnumAsByte<enum class TextureAddress>             AddressX;                                         		// 0x00D0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class TextureAddress>             AddressY;                                         		// 0x00D1(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
