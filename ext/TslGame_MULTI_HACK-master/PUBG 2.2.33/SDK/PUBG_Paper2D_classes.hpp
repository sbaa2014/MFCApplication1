...
public:
	...
	TEnumAsByte<enum class ESpriteCollisionMode>       SpriteCollisionDomain;                            		// 0x0098(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class EFlipbookCollisionMode>     CollisionSource;                                  		// 0x0048(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	class UPaperFlipbook*                              SourceFlipbook;                                   		// 0x0750(0x0008) (CPF_Edit, CPF_Net, CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UMaterialInterface*                          Material;                                         		// 0x0758(0x0008) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	float                                              PlayRate;                                         		// 0x0760(0x0004) (CPF_Edit, CPF_Net, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bLooping : 1;                                     		// 0x0764(0x0001) (CPF_Net)
	unsigned char                                      bReversePlayback : 1;                             		// 0x0764(0x0001) (CPF_Net)
	unsigned char                                      bPlaying : 1;                                     		// 0x0764(0x0001) (CPF_Net)
	unsigned char                                      UnknownData00[0x3];                               		// 0x0765(0x0003) MISSED OFFSET
	float                                              AccumulatedTime;                                  		// 0x0768(0x0004) (CPF_Net, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                CachedFrameIndex;                                 		// 0x076C(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FLinearColor                                SpriteColor;                                      		// 0x0770(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UBodySetup*                                  CachedBodySetup;                                  		// 0x0780(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	struct FScriptMulticastDelegate                    OnFinishedPlaying;                                		// 0x0788(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
...
{
public:
	class UPaperFlipbookComponent*                     RenderComponent;                                  		// 0x0388(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ExportObject, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
...
{
public:
	TArray<class UMaterialInterface*>                  InstanceMaterials;                                		// 0x0750(0x0010) (CPF_ZeroConstructor)
	TArray<struct FSpriteInstanceData>                 PerInstanceSpriteData;                            		// 0x0760(0x0010) (CPF_Edit, CPF_ZeroConstructor)
...
{
public:
	class UPaperGroupedSpriteComponent*                RenderComponent;                                  		// 0x0388(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ExportObject, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
...
{
public:
	class UPaperSprite*                                SourceSprite;                                     		// 0x0750(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UMaterialInterface*                          MaterialOverride;                                 		// 0x0758(0x0008) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	struct FLinearColor                                SpriteColor;                                      		// 0x0760(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	class UPaperSpriteComponent*                       RenderComponent;                                  		// 0x0388(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ExportObject, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
...
{
public:
	class USceneComponent*                             DummyRoot;                                        		// 0x0388(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
	class UPaperTerrainSplineComponent*                SplineComponent;                                  		// 0x0390(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
	class UPaperTerrainComponent*                      RenderComponent;                                  		// 0x0398(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ExportObject, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
...
{
public:
	unsigned char                                      bClosedSpline : 1;                                		// 0x06A0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bFilledSpline : 1;                                		// 0x06A1(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x6];                               		// 0x06A2(0x0006) MISSED OFFSET
	class UPaperTerrainSplineComponent*                AssociatedSpline;                                 		// 0x06A8(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
	int                                                RandomSeed;                                       		// 0x06B0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              SegmentOverlapAmount;                             		// 0x06B4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FLinearColor                                TerrainColor;                                     		// 0x06B8(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                ReparamStepsPerSegment;                           		// 0x06C8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class ESpriteCollisionMode>       SpriteCollisionDomain;                            		// 0x06CC(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                               		// 0x06CD(0x0003) MISSED OFFSET
	float                                              CollisionThickness;                               		// 0x06D0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                               		// 0x06D4(0x0004) MISSED OFFSET
	class UBodySetup*                                  CachedBodySetup;                                  		// 0x06D8(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient, CPF_IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum class ESpriteCollisionMode>       SpriteCollisionDomain;                            		// 0x0084(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<enum class ETileMapProjectionMode>     ProjectionMode;                                   		// 0x0085(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	class UPaperTileMapComponent*                      RenderComponent;                                  		// 0x0388(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ExportObject, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
...
{
public:
	int                                                MapWidth;                                         		// 0x0750(0x0004) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	int                                                MapHeight;                                        		// 0x0754(0x0004) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	int                                                TileWidth;                                        		// 0x0758(0x0004) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	int                                                TileHeight;                                       		// 0x075C(0x0004) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	class UPaperTileSet*                               DefaultLayerTileSet;                              		// 0x0760(0x0008) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	class UMaterialInterface*                          Material;                                         		// 0x0768(0x0008) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	TArray<class UPaperTileLayer*>                     TileLayers;                                       		// 0x0770(0x0010) (CPF_ZeroConstructor, CPF_Deprecated)
	struct FLinearColor                                TileMapColor;                                     		// 0x0780(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                UseSingleLayerIndex;                              		// 0x0790(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bUseSingleLayer : 1;                              		// 0x0794(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                               		// 0x0795(0x0003) MISSED OFFSET
	class UPaperTileMap*                               TileMap;                                          		// 0x0798(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
