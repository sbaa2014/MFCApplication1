...
public:
	...
	void OnSlotButtonClicked__DelegateSignature(TEnumAsByte<enum class KeyState> KeyState, const struct FTslInputKey& OriginKey, const struct FTslInputKey& LastDownedKey);
};
