...
public:
	...
	TEnumAsByte<enum class EPathFollowingRequestResult> MoveToLocation(const struct FVector& Dest, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bProjectDestinationToNavigation, bool bCanStrafe, class UClass* FilterClass, bool bAllowPartialPath);
...
public:
	...
	class UAITask_MoveTo* STATIC_AIMoveTo(class AAIController* Controller, const struct FVector& GoalLocation, class AActor* GoalActor, float AcceptanceRadius, TEnumAsByte<enum class EAIOptionFlag> StopOnOverlap, TEnumAsByte<enum class EAIOptionFlag> AcceptPartialPath, bool bUsePathfinding, bool bLockAILogic);
};
